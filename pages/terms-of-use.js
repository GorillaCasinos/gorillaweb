    ...
    return (
        <div className='terms-of-use'>
            <article>
                ...
                <p> Gorilla Token is brought to you by RadiantBlue Limited. (“RadiantBlue Limited”) and its
                    affiliates (collectively, “we,” “us,” or “our”) committed to creating open-source software that
                    empowers users&apos; financial, social and cultural independence. Gorilla Token provides information
                    and resources about the fundamentals of the decentralized non-custodial liquidity protocol called
                    the Gorilla Token Protocol (the Gorilla Token Protocol” or “Protocol”). Gorilla Token is not one of the
                    available access points to the Gorilla Token Protocol.
                </p>
                <p> ARBITRATION NOTICE: THESE TERMS (“TERMS”) CONTAIN AN ARBITRATION CLAUSE BELOW. EXCEPT FOR CERTAIN
                    ...
                    INCLUDE OUR VARIOUS WEBSITES, INCLUDING, WITHOUT LIMITATION, Gorilla Token (AND ANY RESPECTIVE
                    ...
                    THESE TERMS, Gorilla Token - PRIVACY POLICY (FOUND HERE), AND OTHER POLICIES REFERENCED HEREIN
                ...
                <p>
                    ...
                    Services at contact@gorilla-coin.com. When you communicate with us electronically, you consent to
            ...
            <article>
                ...
                <p>Gorilla Token provides resources about the fundamentals of the Gorilla Token Protocol, which is a
                    fully
                    decentralized, community governed protocol deployed on multiple blockchain networks and systems, and
                    provides
                    information about the wider Gorilla Token ecosystem, governance, community, and various interfaces and
                    integrations to the Gorilla Token Protocol. All information provided in connection with your access and
                    use
                    ...
                    Gorilla Token Protocol, these Terms also provide some information about the use of the Protocol. This
                    information is
                ...
                <h2>We are software developers in the Gorilla Token Protocol ecosystem.</h2>
                <p>
                    It is important to understand that neither we nor any affiliated entity is a party to any
                    transaction on
                    the blockchain networks underlying the Gorilla Token Protocol; we do not have possession, custody or
                    control
                    ...
                    when
                    you interact with any Gorilla Token Protocol smart contracts, you retain control over your cryptoassets
                    at
                ...
                <p> The software underlying blockchain networks on which the Gorilla Token Protocol is deployed, including,
                    for
                    ...
                    operation of the blockchain-based software and networks underlying the Gorilla Token Protocol, (ii) that
                ...
                <h2>Gorilla Token Ecosystem and Community contributors are independent.</h2>
                <p>All community contributors to the ecosystem around the Gorilla Token Protocol are independent of us, and
                    we
            ...
            <article>
                ...
                <p>Transactions on the Gorilla Token Protocol rely on smart contracts stored on various blockchains,
            ...
            <article>
                ...
                <p>
                    ...
                    materials that you may access or use on or through the Services; however, the code for the Gorilla Token
                    Protocol
                    and the front-end interface (app.gorilla-coin.com) deployed on IPFS is open-sourced. Except as
                    expressly set
